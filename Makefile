...
deploy-weeth-arbitrum :; forge script scripts/DeployArbitrum.s.sol:DeployWeEthArbitrum --rpc-url arbitrum $(common-flags)
deploy-gho-arbitrum :; forge script scripts/DeployArbitrum.s.sol:DeployGhoArbitrum --rpc-url arbitrum $(common-flags)
